...
async def main():
    ...
    app.router.add_post("/api/send-image", handle_send_image)
    app.router.add_post("/api/send-video", handle_send_video)
    ...
    app.router.add_get("/api/group-files", handle_group_files)
    app.router.add_post("/api/group-files/upload", handle_group_file_upload)
    app.router.add_post("/api/group-files/folders", handle_group_file_folder_create)
    app.router.add_delete("/api/group-files/files", handle_group_file_delete)
    ...
    app.router.add_post("/api/background-image", handle_background_image_upload)
